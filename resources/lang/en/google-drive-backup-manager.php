...
return [
    ...
    'notifications' => [
        ...
        'cleanup_confirm_body' => 'This runs your retention strategy now, permanently deleting backups on Google Drive that fall outside the window configured in Settings → Cleanup. This cannot be undone.',
        'cleanup_queued_title' => 'Cleanup queued',
        'cleanup_queued_body' => 'Cleanup has been queued and will run shortly.',
